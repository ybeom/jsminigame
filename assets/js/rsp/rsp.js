...
function matchResult(event) {
    ...
    //비겼을 때
    if ((paper_state === true && current_state.innerText === "보") || (scissor_state === true && current_state.innerText === "가위") || (rock_state === true && current_state.innerText === "바위")) {
        result_box.innerText = "비겼습니다.";
        appearRetrybtn();
    }
    //이겼을 때
    if ((paper_state === true && current_state.innerText === "가위") || (scissor_state === true && current_state.innerText === "바위") || (rock_state === true && current_state.innerText === "보")) {
        result_box.innerText = "이겼습니다.";
        appearRetrybtn();
    }
    //졌을 때
    if ((paper_state === true && current_state.innerText === "바위") || (scissor_state === true && current_state.innerText === "보") || (rock_state === true && current_state.innerText === "가위")) {
